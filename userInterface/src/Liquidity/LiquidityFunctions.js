...
// Function used to add Liquidity to any pair of tokens or token-WETH
// To work correctly, there needs to be 9 arguments:
//    `address1` - An Ethereum address of the coin to add from (either a token or WETH)
//    `address2` - An Ethereum address of the coin to add to (either a token or WETH)
...
// Function used to remove Liquidity from any pair of tokens or token-WETH
// To work correctly, there needs to be 9 arguments:
//    `address1` - An Ethereum address of the coin to recieve (either a token or WETH)
//    `address2` - An Ethereum address of the coin to recieve (either a token or WETH)
