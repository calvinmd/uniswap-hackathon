...
import * as UNI from "../constants/uni";
...
function CoinSwapper(props) {
  ...
  return (
    <div>
      ...
      >
        <p>
          UNISWAP | Get Testnet ETH for Rinkeby at {" "}
